  ...
  return (
    <section className="relative pt-24 pb-12 md:pt-32 md:pb-20">
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        {/* Main Hero Image */}
        <div className="w-48 md:w-64 mx-auto mb-8 md:mb-12 transform hover:scale-[1.05] transition-transform duration-700">
            <img 
                src={heroImageUrl} 
                alt="Polymarket Hero Art" 
                className="w-full h-auto block drop-shadow-[0_0_60px_rgba(59,130,246,0.2)] rounded-full border-4 border-slate-800"
            />
        </div>
