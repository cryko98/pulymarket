...
const COOLCAT_LOGO = "https://pbs.twimg.com/media/G8TVwV2XgAczA4R?format=jpg&name=large";
  ...
  <section className="py-16 md:py-24 bg-slate-950 text-white relative overflow-hidden border-y border-slate-800">
    ...
    <div className="container mx-auto px-4 max-w-6xl relative z-10">
      <div className="text-center mb-12 md:mb-16">
        <div className="inline-block bg-purple-600 text-white px-5 py-1.5 rounded-full mb-6 font-bold uppercase tracking-widest text-xs md:text-sm shadow-xl">
          The Memecoin with a Crystal Ball
        </div>
        <h2 className="text-4xl md:text-7xl font-bold mb-6 md:mb-8 tracking-tighter leading-tight text-slate-100">
          The Meme Version of <br/><span className="text-purple-400">The Future.</span>
        </h2>
        <p className="text-lg md:text-xl font-medium max-w-4xl mx-auto leading-relaxed text-slate-400 px-2">
          $COOLCAT isn't just a memecoin; it's a decentralized oracle powered by community vibes. This is a live prediction terminal where the degen collective defines the meta and predicts the future of memes.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 items-stretch">
        <div className="flex flex-col gap-6 md:gap-8">
          <div className="bg-slate-900 p-6 md:p-8 rounded-3xl border border-slate-800 shadow-sm">
            <h3 className="text-2xl md:text-3xl font-bold mb-4 flex items-center gap-3 text-slate-100">
              <Cpu size={28} className="md:w-8 md:h-8 text-purple-500" />
              Community Prophecies
            </h3>
            <p className="text-base md:text-lg font-medium text-slate-400 leading-snug">
              Every holder is an oracle. Anyone can deploy their own custom prediction market. Propose any outcome—from macro trends to the next viral moonshot—and let the community's conviction provide the answer.
            </p>
          </div>
          
          <div className="bg-purple-600 text-white p-6 md:p-8 rounded-3xl shadow-2xl shadow-purple-500/20 relative overflow-hidden group">
        ...
        <div className="bg-slate-900 text-white p-8 md:p-10 rounded-3xl shadow-2xl flex flex-col justify-center border border-slate-800 relative overflow-hidden">
          <div className="absolute -bottom-10 -right-10 w-48 h-48 md:w-64 md:h-64 bg-purple-500 rounded-full blur-[80px] md:blur-[120px] opacity-10"></div>
          <div className="relative z-10">
            <div className="bg-purple-600 text-white w-14 h-14 md:w-16 md:h-16 rounded-2xl flex items-center justify-center mb-6 md:mb-8 shadow-lg shadow-purple-500/20">
            ...
            <ul className="space-y-4 font-bold uppercase text-xs md:text-sm tracking-widest text-slate-300">
              <li className="flex items-center gap-3"><TrendingUp size={16} className="text-purple-400 md:w-[18px] md:h-[18px]" /> Dexscreener Real-time API</li>
              <li className="flex items-center gap-3"><Activity size={16} className="text-purple-400 md:w-[18px] md:h-[18px]" /> Dynamic Market Cap Feeds</li>
              <li className="flex items-center gap-3"><Search size={16} className="text-purple-400 md:w-[18px] md:h-[18px]" /> Automated On-chain Tracking</li>
            </ul>
          </div>
        </div>
      </div>
      ...
      <div className="mt-16 md:mt-20 text-center border-t-2 border-dashed border-slate-800 pt-10 md:pt-12">
        <p className="text-2xl md:text-5xl font-black uppercase italic tracking-tighter text-slate-100 px-2">
          ...
          <span className="bg-purple-600 text-white px-2 md:px-4 leading-relaxed box-decoration-clone">ONLY COOLCAT SURVIVES.</span>
        </p>
      </div>
    </div>
  </section>
    ...
    <div className="container mx-auto px-4 max-w-6xl relative z-10">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8">
        <div className="bg-slate-950 p-8 rounded-3xl shadow-xl hover:scale-105 transition-transform border border-slate-800">
          <div className="bg-purple-600 text-white w-12 h-12 md:w-14 md:h-14 rounded-2xl flex items-center justify-center mb-6 shadow-lg shadow-purple-500/20">
...
function App() {
  ...
  return (
    <div className="min-h-screen text-white font-sans selection:bg-purple-500 selection:text-white bg-slate-900 overflow-x-hidden">
          ...
          <div className="pt-16 min-h-screen bg-slate-900 animate-in slide-in-from-right duration-500 flex flex-col">
            <div className="bg-slate-950/80 backdrop-blur-sm border-b border-slate-800 px-4 md:px-8 py-3 flex justify-between items-center shrink-0">
               <div className="flex items-center gap-2 md:gap-4 text-slate-400 font-mono text-[9px] md:text-[11px] uppercase tracking-wider md:tracking-widest overflow-hidden whitespace-nowrap">
                  <Terminal size={12} className="text-purple-500 shrink-0 md:w-[14px] md:h-[14px]" />
                  <span className="truncate">Connection: Secure // Provider: COOLCAT Oracle // Live</span>
               </div>
      ...
      <footer className="border-t border-slate-800 py-8 md:py-12 bg-slate-950 text-center">
        <div className="flex justify-center items-center gap-3 mb-4">
            ...
            <span className="font-bold text-slate-200 text-xl md:text-2xl uppercase tracking-tighter">COOLCAT</span>
        </div>
        <p className="text-xs md:text-sm font-bold uppercase tracking-widest text-slate-500 px-4">© 2024 THE COOLEST CAT ON SOLANA</p>
      </footer>
    </div>
  );
}
